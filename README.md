...
Правим файлы конфигурации /etc/my.cnf на обоих серверах. Для сервере, на который будем реплицировать данные, добавляем запрет на внесение и изменение данных в конфиг файл read_only=1.
